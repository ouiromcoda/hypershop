...
class CinetPay
{
    ...
    public function getOnlyPayButtonToSubmit($formName, $btnType = 1, $size)
    {
        ...
        if (!empty($formName) && $btnType == 1) {
            $btn = "<button class='btn btn-primary checkout-btn " . $size . "'> Acheter </button>";
        } elseif (!empty($formName) && $btnType == 2) {
            $btn = "<button class='btn btn-primary checkout-btn " . $size . "'> Payer </button>";
        } elseif (!empty($formName) && $btnType == 3) {
            $btn = "<button class='btn btn-primary checkout-btn " . $size . "'> Faire un don </button>";
        } elseif (!empty($formName) && $btnType == 4) {
            $btn = "<button class='btn btn-primary checkout-btn " . $size . "'> Payer avec CinetPay</button>";
        } else {
            $btn = "<button class='btn btn-primary checkout-btn " . $size . "'> Payer maintenant </button>";
        }
        return $btn;
    }
