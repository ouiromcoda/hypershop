...
<form method="post" action="<?php echo site_url('mot-de-passe-oublie'); ?>" class="form-vertical">
...
<?php
    echo "<div class='success'>".$this->session->flashdata('email_sent')."</div> <p>&nbsp;</p>";
...
<input class="m-wrap placeholder-no-fix" type="text" placeholder="Email" autocomplete="off" name="email_user"/>
<?php echo form_error('email_user','<span class="error">','</span>'); ?>
</div>
</div>
</div>
<div class="form-actions">
<a href="<?php echo site_url('espace-client'); ?>" id="back-btn" class="btn">
