...
class Model_customer extends CI_Model {
	...
	public function get_shopping_history($usr_id)
		...
		function getUserInfoInvoice($usr_id)
		{
			$this->db->select()->from('invoices')->where('user_id',$usr_id)->order_by('created_at','desc');
